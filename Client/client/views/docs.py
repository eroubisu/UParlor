    ...
    match key:
        ...
        case 'menu':
            return (
                ...
                "\n"
                f"  {M_CMD}w{M_END}  切换聚焦    {M_CMD}c{M_END}  聊天\n"
                f"  {M_CMD}o{M_END}  在线        {M_CMD}n{M_END}  通知\n"
                f"  {M_CMD}g{M_END}  游戏        {M_CMD}s{M_END}  设置"
            )
        case 'input':
            return (
                f"{M_BOLD}输入模式{M_END}\n"
        ...
        case 'focus':
            return (
                ...
                f"{sep}\n"
                "\n"
                f"{M_DIM}大厅有多个面板，切换聚焦方式：{M_END}\n"
                "\n"
                f"  {M_CMD}Space{M_END} → {M_CMD}w{M_END}  进入聚焦模式\n"
                "\n"
                f"{sep}\n"
                f"{M_DIM}然后用方向键选择面板：{M_END}\n"
                "\n"
                f"  {M_CMD}←  ↓  ↑  →{M_END}  选择方向\n"
                "\n"
                f"{M_DIM}选择后自动回到普通模式{M_END}"
            )
        case _:
            return ''
