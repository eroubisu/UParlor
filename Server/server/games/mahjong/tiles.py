...
# 字牌名映射
HONOR_NAMES = {0: '东', 1: '南', 2: '西', 3: '北', 4: '白', 5: '发', 6: '中'}
WIND_NAMES = ['东', '南', '西', '北']
POSITION_NAMES = ['东', '南', '西', '北']
...
_HONOR_PARSE = {'东': 27, '南': 28, '西': 29, '北': 30, '白': 31, '发': 32, '中': 33}

_NUM_CHINESE = ['一', '二', '三', '四', '五', '六', '七', '八', '九']
_SUIT_CHINESE = {0: '万', 1: '筒', 2: '索'}

# 中文名 → 34编码 反向映射
_CHINESE_NUM_PARSE = {'一': 0, '二': 1, '三': 2, '四': 3, '五': 4, '六': 5, '七': 6, '八': 7, '九': 8}
_CHINESE_SUIT_PARSE = {'万': 0, '筒': 1, '索': 2}
